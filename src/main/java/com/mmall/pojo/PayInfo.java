...
public class PayInfo implements Serializable {
	...
	public int hashCode() {
		...
		result = prime * result + ((payPlatform == null) ? 0 : payPlatform.hashCode());
		result = prime * result + ((platformNumber == null) ? 0 : platformNumber.hashCode());
		result = prime * result + ((platformStatus == null) ? 0 : platformStatus.hashCode());
	...
	public boolean equals(Object obj) {
		...
		if (orderNo == null) {
			...
			return false;
		if (payPlatform == null) {
			if (other.payPlatform != null)
				return false;
		} else if (!payPlatform.equals(other.payPlatform))
			return false;
		...
		if (platformStatus == null) {
			if (other.platformStatus != null)
				return false;
		} else if (!platformStatus.equals(other.platformStatus))
			return false;
		if (updateTime == null) {
