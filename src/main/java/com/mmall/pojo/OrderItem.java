...
public class OrderItem implements Serializable {
	...
	public int hashCode() {
		...
		result = prime * result + ((currentUnitPrice == null) ? 0 : currentUnitPrice.hashCode());
	...
	public boolean equals(Object obj) {
		...
		if (currentUnitPrice == null) {
			if (other.currentUnitPrice != null)
				return false;
		} else if (!currentUnitPrice.equals(other.currentUnitPrice))
			return false;
		if (id == null) {
			if (other.id != null)
				return false;
